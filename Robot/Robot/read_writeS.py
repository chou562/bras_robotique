...
while run:
    ...
    #pos5 = round(pos5-(-button5+button6)*Angle)
    #pos5, saturation=valmax(pos5,degretoE(90),degretoE(-90))

    if button5:  # Si le bouton 5 est pressé, ouvrir la pince
        pos5 = min(pos5 + 3*Angle, DXL5_MAXIMUM_POSITION_VALUE)
    elif button6:  # Si le bouton 6 est pressé, fermer la pince
        pos5 = max(pos5 - 3*Angle, DXL5_MINIMUM_POSITION_VALUE)


    #with open('C:/Users/cc105536/Documents/Positions.txt', 'a') as fichier:
    ...
    dxl_comm_result, dxl_error = packetHandler.write4ByteTxRx(portHandler, DXL_ID5, ADDR_PRO_GOAL_POSITION, pos5)
